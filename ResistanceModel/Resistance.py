...
class Resistance(AbstractAgent):
    ...
    def step(self):
        ...
        # State in which a team is chosen
        ...
        # State in which agents vote on whether to accept a mission team
        ...
        # State in which agents go on mission (for GUI)
        ...
        # State in which the cards are played
        ...
        # After each mission, an agent moves back in the GUI.
        # If reasoning is enabled, an agent reasons about the vote.
    ...
    def choose_team(self):
        ...
        mission_team.append(self.unique_id)  # agents always trusts themselves
    ...
    def decide_on_vote(self):
        """Checks whether a Resistance agent accepts the proposed mission team"""
        # Find relations for the current agent
        relations = self.model.kripke_model.ks.relations[str(self.unique_id)]
        # Find relations to other worlds from the true world
        ...
        # Vote no if an agent is sure a spy is in the mission team
        for s in suspicions:
            if s == len(worlds):
                return False
